...
const Header = () => {
    ...
    return (
        <header className="sticky top-0 z-50 border-b border-primary/10 bg-white/95 dark:bg-background-dark/95 backdrop-blur-sm">
            <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                <div className="flex h-16 sm:h-20 items-center justify-between whitespace-nowrap">
                    ...
                    <nav className="hidden md:flex items-center gap-8">
                        <Link to="/" className="text-sm font-semibold leading-normal text-slate-900 dark:text-slate-100 hover:text-primary transition-colors">Home</Link>
                        <Link to="/fatwas" className="text-sm font-semibold leading-normal text-slate-900 dark:text-slate-100 hover:text-primary transition-colors">Fatwa</Link>
                    ...
                    {/* Mobile Menu Toggle */}
                    <button className="md:hidden text-slate-900 dark:text-slate-100 p-2" onClick={toggleMenu} aria-label="Toggle Menu">
            ...
            {isMenuOpen && (
                <div className="border-b border-primary/10 bg-white dark:bg-background-dark px-4 py-6 md:hidden shadow-xl animate-in fade-in slide-in-from-top-4 duration-300">
