            ...
            <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                <div className="flex h-16 sm:h-20 items-center justify-between whitespace-nowrap">
                    ...
                    <nav className="hidden md:flex items-center gap-8">
                        ...
                        <Link to="/fatwas" className="text-sm font-semibold leading-normal text-slate-900 hover:text-primary transition-colors">Fatwa</Link>
            ...
            {isMenuOpen && (
                <div className="border-b border-primary/10 bg-white px-4 py-6 md:hidden shadow-xl animate-in fade-in slide-in-from-top-4 duration-300">
                    <div className="mx-auto max-w-7xl flex flex-col gap-4">
                        ...
                        <Link to="/fatwas" className="text-lg font-bold text-slate-900 border-b border-slate-100 pb-2" onClick={() => setIsMenuOpen(false)}>Fatwa</Link>
